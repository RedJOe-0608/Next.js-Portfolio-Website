...
const LatestArticle = ({ img, title, time, summary, link }) => {
  return (
    <li className="col-span-1 w-full p-4 bg-light dark:bg-dark  dark:text-light shadow-2xl dark:shadow-light dark:shadow-lg border border-dark border-solid dark:border-light rounded-2xl">
      <Link
          ...
          <ul className="grid grid-cols-2 gap-16 lg:gap-8 md:gap-y-16 md:grid-cols-1">
            ...
            >
              <LatestArticle
                ...
                time="9 min read"
                summary="Learn
            how to build a custom pagination component in ReactJS from scratch.
